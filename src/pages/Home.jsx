      ...
      <div className="bg-[#fdfaf1] p-6 border border-gray-400 rounded-lg shadow-lg relative max-w-4xl w-full">
        ...
        <div className="relative z-10">
          ...
          <div className="text-center my-8">
            <p className="text-2xl font-bold text-blue-800">Impact Factor 0.60</p>
            <p className="text-xl font-bold text-purple-700">JCR 2024</p>
          </div>

          {/* Open Access Policy Section */}
          <p className="text-gray-700 leading-relaxed text-justify">
            <strong className="text-blue-800">Open access Policy:</strong> The management of the Journal of Animal and Plant Sciences ensures that the manuscripts published in it are freely accessible online/ via internet immediately upon publication, without any cost/barrier of subscription/registration to the readers universally.
          </p>
        </div>
      </div>
    </div>
