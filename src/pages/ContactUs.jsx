...
const Contact = () => {
  return (
    ...
    <div className="flex justify-center items-start w-full">
      {/* The main content box with border and background color */}
      <div className="bg-[#fdfaf1] p-6 border border-gray-400 rounded-lg shadow-lg relative max-w-4xl w-full">
        ...
        {/* Content container with a higher z-index to appear above the watermark */}
        <div className="relative z-10">
          ...
          <div className="border border-gray-300 p-4">
            ...
            <div className="text-gray-700 space-y-1">
              <p className="font-bold text-blue-800 text-lg">Prof. Dr. Khalid Javed</p>
              <p>Chief Editor</p>
              <p className="mt-2">146-Rizwan Block, Awan Town, Multan Road, Lahore-54780, Pakistan</p>
              <p className="mt-2">
                E-mail: 
                <a href="mailto:editor@thejaps.org.pk" className="text-red-700 hover:underline ml-1">
                  editor@thejaps.org.pk
                </a>;
                <a href="mailto:javeddrkhalid@yahoo.com" className="text-red-700 hover:underline ml-1">
